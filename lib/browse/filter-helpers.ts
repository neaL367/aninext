...
export function toggleFormat(params: AnimeListParams, format: MediaFormat): AnimeListParams {
  return {
    ...params,
...
export function toggleStatus(params: AnimeListParams, status: MediaStatus): AnimeListParams {
  return {
    ...params,
...
export function toggleGenre(params: AnimeListParams, genre: string): AnimeListParams {
  return {
    ...params,
